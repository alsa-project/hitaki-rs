...
impl ::std::fmt::Debug for HitakiSndDiceClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HitakiSndDiceClass @ {:?}", self as *const _))
...
impl ::std::fmt::Debug for HitakiSndDigi00xClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HitakiSndDigi00xClass @ {:?}", self as *const _))
            .field("parent_class", &self.parent_class)
            .finish()
    }
}
...
impl ::std::fmt::Debug for HitakiSndEfwClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HitakiSndEfwClass @ {:?}", self as *const _))
            .field("parent_class", &self.parent_class)
            .finish()
    }
}
...
impl ::std::fmt::Debug for HitakiSndMotuClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HitakiSndMotuClass @ {:?}", self as *const _))
            .field("parent_class", &self.parent_class)
            .finish()
    }
}
...
impl ::std::fmt::Debug for HitakiSndTascamClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HitakiSndTascamClass @ {:?}", self as *const _))
            .field("parent_class", &self.parent_class)
            .finish()
    }
}
...
impl ::std::fmt::Debug for HitakiSndUnitClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HitakiSndUnitClass @ {:?}", self as *const _))
            .field("parent_class", &self.parent_class)
            .finish()
    }
}
...
impl ::std::fmt::Debug for HitakiSndDice {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HitakiSndDice @ {:?}", self as *const _))
...
impl ::std::fmt::Debug for HitakiSndDigi00x {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HitakiSndDigi00x @ {:?}", self as *const _))
            .field("parent_instance", &self.parent_instance)
            .finish()
    }
}
...
impl ::std::fmt::Debug for HitakiSndEfw {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HitakiSndEfw @ {:?}", self as *const _))
            .field("parent_instance", &self.parent_instance)
            .finish()
    }
}
...
impl ::std::fmt::Debug for HitakiSndMotu {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HitakiSndMotu @ {:?}", self as *const _))
            .field("parent_instance", &self.parent_instance)
            .finish()
    }
}
...
impl ::std::fmt::Debug for HitakiSndTascam {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HitakiSndTascam @ {:?}", self as *const _))
            .field("parent_instance", &self.parent_instance)
            .finish()
    }
}
...
impl ::std::fmt::Debug for HitakiSndUnit {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HitakiSndUnit @ {:?}", self as *const _))
            .field("parent_instance", &self.parent_instance)
            .finish()
    }
}
...
// Interfaces
#[repr(C)]
pub struct HitakiAlsaFirewire(c_void);

impl ::std::fmt::Debug for HitakiAlsaFirewire {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "HitakiAlsaFirewire @ {:?}", self as *const _)
    }
}

#[repr(C)]
pub struct HitakiEfwProtocol(c_void);

impl ::std::fmt::Debug for HitakiEfwProtocol {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "HitakiEfwProtocol @ {:?}", self as *const _)
    }
}

#[repr(C)]
pub struct HitakiMotuCommandDsp(c_void);

impl ::std::fmt::Debug for HitakiMotuCommandDsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "HitakiMotuCommandDsp @ {:?}", self as *const _)
    }
}

#[repr(C)]
pub struct HitakiMotuRegisterDsp(c_void);

impl ::std::fmt::Debug for HitakiMotuRegisterDsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "HitakiMotuRegisterDsp @ {:?}", self as *const _)
    }
}

#[repr(C)]
pub struct HitakiQuadletNotification(c_void);

impl ::std::fmt::Debug for HitakiQuadletNotification {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "HitakiQuadletNotification @ {:?}", self as *const _)
    }
}

#[repr(C)]
pub struct HitakiTascamProtocol(c_void);

impl ::std::fmt::Debug for HitakiTascamProtocol {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "HitakiTascamProtocol @ {:?}", self as *const _)
    }
}
